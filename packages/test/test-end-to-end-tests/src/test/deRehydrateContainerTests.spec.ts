        ...
        it("Change contents of dds, then rehydrate and then check summary", async () => {
            ...
            for (const interval of intervalsBefore) {
                if (typeof(interval.getIntervalId) === "function") {
                    assert.notStrictEqual(intervalsAfter.getIntervalById(interval.getIntervalId()), undefined,
                                        "Interval not present after rehydration");
                    intervalsAfter.deleteIntervalById(interval.getIntervalId());
                    assert.strictEqual(intervalsAfter.getIntervalById(interval.getIntervalId()), undefined,
